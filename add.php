...
$path=move_uploaded_file($file_loc,$folder.$file_name);
		$qry=mysqli_query($conn,"insert into turf  values('','$type','$name','$price','$details','$file_name')");
	if($qry)
	{
...
visibility:hidden;
  ...
  <table width="34%" border="0" align="center">
    ...
    <tr>
      <td colspan="2"  align="center" ><div class="style5"><h3>Add PC PARTS</h></div></td>
    </tr>
	...
	<tr>
      ...
      <td>Details</td>
      <td><textarea name="details" type="text"  required></textarea></td>
