...
$qry=mysqli_query($conn,"select * from merge where processor='$pro'");
...
?>
<h2 style="width:300px;margin:20px auto;"><?php echo $pro; ?> MOTHER BOARD OPTIONS</h2>

<div class="main2">

<a href="p.php?pro=<?php echo $pro;?>&mb=<?php echo $row1['tname'];?>"><div> <img src="upload\<?php echo $row1['img']; ?>" width="400px" height="170px"/>
